...
func TestHttpUriSuffix(t *testing.T) {
	tests := []struct {
		...
		{"Valid", "/v1/{name=publishers/*/writeBookJobs/*}:run", "RunWriteBookJob", nil},
		{"InvalidSuffix", "/v1/{name=publishers/*/writeBookJobs/*}", "RunWriteBookJob", testutils.Problems{{Message: ":run"}}},
