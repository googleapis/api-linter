...
func TestHttpUriSuffix(t *testing.T) {
	tests := []struct {
		...
		{"Valid", "/v1/{parent=publishers/*}/books:batchDelete", "BatchDeleteBooks", nil},
		{"ValidNoParent", "/v1/books:batchDelete", "BatchDeleteBooks", nil},
		{"InvalidSuffix", "/v1/{parent=publishers/*}/books", "BatchDeleteBooks", testutils.Problems{{Message: ":batchDelete"}}},
